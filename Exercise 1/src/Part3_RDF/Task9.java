...
public class Task9 {
	...
	public static void main(String[] args) {
		...
		String queryString = "SELECT ?country ?label ?population WHERE {?country <"
				+ RDFS.label + "> ?label . ?country <http://www.geonames.org/ontology#population> ?population } ORDER BY DESC(?population) LIMIT 5 OFFSET 5";
		...
		while (results.hasNext()) {
			...
			System.out.println(solution.get("country").toString() + "\t"
					...
					+ solution.get("population").toString());
		}
	}
